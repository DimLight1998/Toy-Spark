...
object TestCase {
  def test(args: Array[String]): Unit = {
    if(args.length > 1) {
      ...
      testid match {
        ...
        case "4"           => test4(args)
        case "5"           => test5(args)
        case "Time"        => testTime(args)
        case "PrimaryMath" => primaryMath(args)
        case "CalculatePi" => calculatePi(args)
        case "SaveHDFS"    => saveHDFS(args)
        case "LoadHDFS"    => loadHDFS(args)
      }
    }
  }

  def test0(args: Array[String]): Unit = {
  ...
  def testTime(args: Array[String]): Unit = {
  ...
  def calculatePi(args: Array[String]): Unit = {
  ...
  def primaryMath(args: Array[String]): Unit = {
  ...
  def saveHDFS(args: Array[String]): Unit = {
  ...
  def loadHDFS(args: Array[String]): Unit = {
